...
from .views import (
    ...
    DesativarContaView, ExcluirContaView,
)
...
urlpatterns = [
    ...
    path('me/desativar/', DesativarContaView.as_view(), name='desativar-conta'),
    path('me/excluir/', ExcluirContaView.as_view(), name='excluir-conta'),
